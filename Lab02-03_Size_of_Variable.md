...
ตอบ 0 เพราะ เกินขอบเขตทำให้เกิด overflow ค่ากลับมาเริ่มต้นที่ 0
...
ตอบ เพราะถ้า float หรือ double  ใช้การหารแบบทศนิยม  ถ้าหาแบบ int ใช้การหารจำนวนเต็ม  ส่วนทศนิยมจะ ถูกตัดทิ้งไม่ปัดเศษ
...
ตอบ - แปลง float เป็น int เพื่อตัดทศนิยมออก

    - แปลง char เป็น int เพื่อดูค่า ASCII

    - แปลง int เป็น float เพื่อให้การหารได้ผลลัพธ์เป็นทศนิยม
